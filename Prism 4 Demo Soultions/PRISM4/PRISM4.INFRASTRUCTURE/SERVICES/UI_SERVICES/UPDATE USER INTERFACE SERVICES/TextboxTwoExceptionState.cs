...
{
    public class TextboxTwoExceptionState : IUpdateUIState
    {
        ...
        private bool TEXTBOX_2_EXCEPTION_STATE = true;
        ...
        private bool TEXTBOX_ONE_AND_TWO_EXCEPTION_STATE = false;
        public bool TextBoxOneAndTwoExceptionState
        {
            get
            {
                return TEXTBOX_ONE_AND_TWO_EXCEPTION_STATE;
            }
        }

        private bool BOTH_TEXTBOXES_BLANK_OR_CLEAR_STATE = false;
